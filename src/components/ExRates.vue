    ...
    <b-container class="mt-5">
        <main v-if="rates">
            ...
            <b-alert class="dis-none" v-else show variant="info mb-4">
                Awaiting BeforeInstallPrompt event to Fire. It would not take so
                long 🙂. If the event
                <strong>didn't fire click</strong> anywhere inside the
        ...
        exchangeCurrency() {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    const firstKeyValue =
                        resRateObj[Object.keys(resRateObj)[0]];
                    const rateExResult = firstKeyValue * this.rateAmount;
                    const roundedExResult =
                        Math.round(rateExResult * hundred) / hundred;
